...
public class Car {
    ...
    //    static variable. shared variables, one copy only
    static String purpose;
    static int count;

    //    no-args constructor
    public Car() {
        this("unknown", "unknown",0); // Instead of writing the following 3 lines one by one, we can write it this way
...
//    constructor is special method, with same name as classname
//    and nno return type. runs automatically when we create an object
...
//        static variable does not need object to be accessed
        ...
        Car.count = 1000;
        System.out.println("Count of cars is " + Car.count);
