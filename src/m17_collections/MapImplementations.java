...
public class MapImplementations {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("keys = "+ gradeScale.keySet());
        System.out.println("values = "+ gradeScale.values());
...
//        contains in a map
        ...
        // map2.add(); there is no add method
        map2.put(4, "four");
        map2.put(1, "one");
        map2.put(7, "seven");
        map2.put(10, "ten");
        ...
        map3.put(5, "five");
        //map3.put(null, "empty"); //null not allowed in TreeMap if you run with this it will give nullpointer exception
...
//        loop through hashmap:
        map2.forEach((k,v) -> System.out.println("first-> "+ k+ " " + v));
        for (Integer key : map2.keySet()){
            System.out.println("second-> " + key+ " " + map2.get(key) );

        }

        for ( Map.Entry<Integer , String> eachEntry : map2.entrySet() ){
            System.out.println("third-> " +eachEntry.getKey() + " " + eachEntry.getValue());
