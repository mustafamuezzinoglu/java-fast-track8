...
public class T09_RemoveIfNotContains {
    ...
    public static void main(String[] args) {
        List<String> words = new ArrayList<String>(Arrays.asList("rabbit", "bribe","bike"));
        String word = "bib";

        List<String> filteredWords1 = new ArrayList<String>();
...
//                get count of character in word from list
                long countFromListWord = Arrays.stream(arr)
                        .filter(x -> x.equals(eachCh))
                        .count();

//                get count of char in word from target word
...
//                if they are not equal . fail it
            ...
            if (match){
                filteredWords1.add(each);                }

        }
        System.out.println("filteredWords1 = " + filteredWords1);
    ...
    List<String> filteredWords2 = new ArrayList<>();
        ...
        System.out.println("filteredWords2 = " + filteredWords2);
